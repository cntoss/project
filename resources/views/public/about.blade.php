                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-6 col-xs-12">
                                <div class="banner_h2__left_image">
                                    <img alt="" src="{{asset('web/images/banner/about-us-img1.jpg')}}">
                                </div>
                            </div>
                    ...
                    <div class="funfacts">
                        <div class="row no-gutters">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="funfact">
                                    <div class="fun__fact_img">
                                        <img src="{{asset('web/images/icon-img/about-us-icon1.')}}png" alt="">
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="funfact">
                                    <div class="fun__fact_img">
                                        <img src="{{asset('web/images/icon-img/about-us-icon2.')}}png" alt="">
                                    </div>
                                    <div class="fun_fact_info">
                                        <h1>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="funfact">
                                    <div class="fun__fact_img">
                                        <img src="{{asset('web/images/icon-img/about-us-icon3.')}}png" alt="">
                                    </div>
                                    <div class="fun_fact_info">
                                        <h1>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="funfact">
                                    <div class="fun__fact_img">
                                        <img src="{{asset('web/images/icon-img/about-us-icon4.')}}png" alt="">
                                    </div>
                                    <div class="fun_fact_info">
                                        <h1>
                                            <span class="counter">2169</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-6 col-xs-12">
                                <div class="banner_h2__left_image lft_to_right">
                                    <img alt="" src="{{asset('web/images/banner/about-us-img2.jpg')}}">
                                </div>
                            </div>
                        </div>
                    </div>
